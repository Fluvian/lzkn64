...
parser.add_argument("uncompressed_dir", help="The directory containing the uncompressed files.")
parser.add_argument("compressed_dir", help="The directory containing the compressed files.")
parser.add_argument("--temp_dir", help="The temporary directory to store the compressed files in.", default="temp")
